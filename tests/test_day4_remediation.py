...
class Day4RemediationTests(unittest.TestCase):
    ...
    def test_deterministic_artifacts_match_external_network_remediation(self):
        ...
        self.assertEqual(
            ...
            {
                "derivaciones_simuladas.csv": "aaa2724abba37dcdb01a244d71ec9368cc1472aa00920c789da7654463e0d306",
                "cirugias_simuladas.csv": "45321089649a6f280cd531b4d6205306df72aa818710cef3499a398b1a209e86",
